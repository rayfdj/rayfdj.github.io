...
**Andrej Karpathy** (founding team of OpenAI, former AI Director at Tesla, Stanford PhD) summarized AI coding tools as overhyped [on the Dwarkesh Patel podcast](https://www.dwarkesh.com/p/andrej-karpathy) in October 2025. His exact words: the models are "not there" and the industry is "trying to pretend like this is amazing, and it's not. It's slop."

Two months later, on December 27, he [posted](https://x.com/karpathy/status/2004607146781278521) what became one of the most-shared developer tweets of the year:
...
Then in late January, he [shared field notes](https://x.com/karpathy/status/2015883857489522876) from weeks of heavy AI coding use. He'd gone from 80% manual / 20% AI to 80% AI / 20% manual in a matter of weeks. His words: "easily the biggest change to my basic coding workflow in ~2 decades of programming and it happened over the course of a few weeks."

**David Heinemeier Hansson (DHH)**, creator of Ruby on Rails and co-founder of Basecamp, is one of the most opinionated people in software. In [July 2025 on the Lex Fridman podcast](https://lexfridman.com/dhh-david-heinemeier-hansson/), he described using AI to code as feeling like "competence draining out of my fingers." He'd tried the tools and hated them. His advice at the time: don't let AI write your code directly.

Six months later, he [reversed course](https://x.com/dhh/status/2007504187568074843): "Half the resistance was simply that the models weren't good enough yet. I spent more time rewriting what it wrote than if I'd done it from scratch. That has now flipped." On his blog, he [called them](https://world.hey.com/dhh/promoting-ai-agents-3ee04945) "fully capable of producing production-grade contributions to real-life code bases."
...
Your CTO needs your air cover. Give it to them. There's a reason Jamie Dimon [pulled AI out of JPMorgan's technology org entirely](https://www.constellationr.com/blog-news/insights/jpmorgan-chases-dimon-ai-data-cybersecurity-and-managing-tech-shifts). His words: "We took AI and data out of technology. It's too important." He made it a leadership priority, not just a tech initiative. You should too.
